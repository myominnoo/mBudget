...
##
golem::fill_desc(
  pkg_name = "mBudget", # The Name of the package containing the App
  pkg_title = "Myo's Budget App", # The Title of the package containing the App
  pkg_description = "A shiny app to manage personal budget.",
  ...
  repo_url = "https://github.com/myominnoo/mBudget", # The URL of the GitHub Repo (optional),
